...
public class SubQuery {
    ...
    public static enum RollupUsage {
        ROLLUP_NOFALLBACK("ROLLUP_NOFALLBACK"), ROLLUP_RAW("ROLLUP_RAW"), ROLLUP_FALLBACK("ROLLUP_FALLBACK"), ROLLUP_FALLBACK_RAW("ROLLUP_FALLBACK_RAW");

        private String usage;

        RollupUsage(String usage) {
            this.usage = usage;
        }
